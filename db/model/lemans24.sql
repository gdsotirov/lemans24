...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lemans24`.`RacesByCarsFinished` (`Year` INT, `Started` INT, `Finished` INT, `FinishedPercent` INT, `Disqualified` INT, `Retired` INT);
