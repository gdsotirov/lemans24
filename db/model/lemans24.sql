...
-- Schema lemans24
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `lemans24` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ;
USE `lemans24` ;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lemans24`.`MostWinsByDriver` (`Driver` INT, `Wins` INT, `Years` INT);

-- -----------------------------------------------------
-- Placeholder table for view `lemans24`.`MostWinsByTeam`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lemans24`.`MostWinsByTeam` (`Team` INT, `Wins` INT, `Years` INT);

-- -----------------------------------------------------
-- Placeholder table for view `lemans24`.`MostWinsByTeamWAppr`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lemans24`.`MostWinsByTeamWAppr` (`Team` INT, `Wins` INT, `Years` INT);

-- -----------------------------------------------------
-- Placeholder table for view `lemans24`.`TotalStartsByDriver`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lemans24`.`TotalStartsByDriver` (`Driver` INT, `DCountry` INT, `Starts` INT, `Years` INT);

-- -----------------------------------------------------
-- Placeholder table for view `lemans24`.`MostPodiumsByDriver`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lemans24`.`MostPodiumsByDriver` (`Driver` INT, `FstPlace` INT, `SndPlace` INT, `TrdPlace` INT, `TtlPodiums` INT, `Years` INT);
